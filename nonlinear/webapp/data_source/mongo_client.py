...
class MongoClient:
    ...
    def prepare_db(self):
        if "DefaultDataSpecs" not in self.person_db:
            ...
            default_data = {
                ...
                "Vietnam", "Mexico", "Portugal", "
                                                 "Ireland", "France", "Dominican-Republic", "Laos", "Ecuador", "Taiwan", "Haiti", "Columbia", "Hungary", "Guatemala", "Nicaragua", "Scotland", "Thailand", "Yugoslavia", "El-Salvador", "Trinadad&Tobago",
